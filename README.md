This framework helps developer to generate dynamic complex SOQL queries. This framework avoid the use of magic string in the code. This framework use builder pattern. 
